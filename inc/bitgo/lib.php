...
class BitGoSDK
{
    ...
    private $url = null;
    private $params = [];
    private $allowedCoins = ['btc', 'bch', 'bsv', 'btg', 'eth', 'dash', 'ltc', 'xlm','xrp', 'zec', 'rmg', 'erc', 'omg', 'zrx', 'fun', 'gnt', 'rep', 'bat', 'knc', 'cvc', 'eos', 'qrl', 'nmr', 'pay', 'brd', 'tbtc', 'tbch', 'tbsv', 'teth', 'tdash', 'tltc', 'txrp', 'tzec', 'trmg', 'terc'];
    ...
    public function coinLogo(string $coin = CurrencyCode::BITCOIN)
    {
       $coinlogo = 'assets/img/'.$coin.'.png';
 
        if(file_exists($coinlogo)){
         return $coinlogo;
        }else{
    ...
    public function FormatUSD(float $amount)
    {
    ...
    public function invoiceID(int $length = 16)
    {
     ...
     * @param string $amount
     */
    public static function to_bitcoin(float $amount)
    {
        $url = 'https://bitpay.com/api/rates';
        $json = json_decode(file_get_contents($url));
        foreach ($json as $obj)
        {
            if ($obj->code == 'USD') $rate = $obj->rate;
        }
        return sprintf('%.8f', 1 / $rate * $amount, 8);;
    ...
    public function invoiceValidity($time)
    {
        $exp = (time() + $time) - time();
        return $exp;
    }
    ...
    public function unlockSession(string $otp, int $duration = 600)
    {
        ...
        $this->params = ['otp' => $otp, 'duration' => $duration];
        return $this->__execute();
    }
    ...
    public function listWallets(int $limit = 25, string $prevId = null, bool $allTokens = false)
    {
        ...
        $this->params = ['limit' => $limit, 'prevId' => $prevId, 'allTokens' => $this->coin === CurrencyCode::ETHEREUM || $this->coin === CurrencyCode::ETHEREUM_TESTNET ? $allTokens : null, ];
        return $this->__execute('GET');
    }
    ...
    public function getWallet(bool $allTokens = false)
    {
        ...
        $this->params = ['allTokens' => $this->coin === CurrencyCode::ETHEREUM || $this->coin === CurrencyCode::ETHEREUM_TESTNET ? $allTokens : null, ];
        return $this->__execute('GET');
    }
    ...
    public function listWalletTransfers(string $prevId = null, bool $allTokens = false)
    {
        ...
        $this->params = ['prevId' => $prevId, 'allTokens' => $this->coin === CurrencyCode::ETHEREUM || $this->coin === CurrencyCode::ETHEREUM_TESTNET ? $allTokens : null, ];
        return $this->__execute('GET');
    }
    ...
    public function createWalletAddress(int $chain = AddressType::P2SH_DEPOSIT, string $label = null, bool $lowPriority = false, int $gasPrice = null)
    {
        ...
        $this->params = ['chain' => $chain, 'label' => $label, 'lowPriority' => $this->coin === CurrencyCode::ETHEREUM ? $lowPriority : null, 'gasPrice' => $this->coin === CurrencyCode::ETHEREUM ? $gasPrice : null, ];
        return $this->__execute();
    }
    ...
    public function getWalletAddress(string $addressOrId, string $dt = null, string $memoId = null)
    {
        ...
        $this->params = ['dt' => $this->coin === CurrencyCode::RIPPLE ? $label : null, 'memoId' => $this->coin === CurrencyCode::STELLAR ? $label : null];
        return $this->__execute('GET');
    }
    ...
    {
        $this->url = $this->APIEndpoint . '/wallet/' . $this->walletId . '/address/' . $addressOrId;
        $this->params = ['dt' => $this->coin === CurrencyCode::RIPPLE ? $label : null, 'memoId' => $this->coin === CurrencyCode::STELLAR ? $label : null, 'label' => $label];
    ...
    public function getWalletAddresses(string $labelContains = null, int $limit = null, bool $mine = null, string $prevId = null, array $chains = [], int $sort = null)
    {
        ...
        $this->params = ['labelContains' => $labelContains, 'limit' => $limit, 'mine' => $mine, 'prevId' => $prevId, 'chains' => $chains, 'sort' => $sort];
        return $this->__execute('GET');
    }
    ...
    public function listWalletUnspents(string $prevId = null, int $minValue = null, int $maxValue = null, int $minHeight = null, int $minConfirms = null)
    {
        ...
        $this->params = ['prevId' => $prevId, 'minValue' => $minValue, 'maxValue' => $maxValue, 'minHeight' => $minHeight, 'minConfirms' => $minConfirms];
        return $this->__execute('GET');
    }
    ...
    public function getMaximumSpendable(int $limit = null, int $minValue = null, int $maxValue = null, int $minHeight = null, int $feeRate = null, int $minConfirms = null, bool $enforceMinConfirmsForChange = null)
    {
        ...
        $this->params = ['limit' => $limit, 'minValue' => $minValue, 'maxValue' => $maxValue, 'minHeight' => $minHeight, 'feeRate' => $feeRate, 'minConfirms' => $minConfirms, 'enforceMinConfirmsForChange' => $enforceMinConfirmsForChange];
        return $this->__execute('GET');
    }
    ...
    public function listKeychains(int $limit = 25, string $prevId = null)
    {
        ...
        $this->params = ['limit' => $limit, 'prevId' => $prevId];
        return $this->__execute('GET');
    }
    ...
    {
        $this->url = $this->APIEndpoint . '/key';
        $this->params = ['source' => $source, 'enterprise' => $this->coin === CurrencyCode::ETHEREUM ? $enterprise : null, 'newFeeAddress' => $this->coin === CurrencyCode::ETHEREUM ? $newFeeAddress : null];
        return $this->__execute();
    }
    ...
    {
        $this->url = $this->APIEndpoint . '/key';
        $this->params = ['source' => $source, 'provider' => $provider];
        return $this->__execute();
    }
    ...
    {
        $this->url = $this->APIEndpoint . '/key';
        $this->params = ['pub' => $pub, 'encryptedPrv' => $encryptedPrv, 'source' => $source];
        return $this->__execute();
    }
    ...
    public function setVelocityPolicyRule(string $id, string $type, string $condition, string $action)
    {
        ...
        $this->params = ['id' => $id, 'type' => $type, 'condition' => $condition, 'action' => $action];
        return $this->__execute();
    }
    ...
    {
        $this->url = $this->APIEndpoint . '/walletshare/' . $shareId;
        $this->params = ['walletShareId' => $shareId];
        return $this->__execute('DELETE');
    }
    ...
    public function removeWalletUser(string $userId)
    {
        ...
        $this->params = ['walletId' => $this->walletId, 'userId' => $userId];
        return $this->__execute('DELETE');
    }
    ...
    public function listPendingApprovals(string $walletID = null, string $enterprise = null, bool $allTokens = false)
    {
        ...
        $this->params = ['walletID' => $walletID, 'enterprise' => $this->coin === CurrencyCode::ETHEREUM ? $enterprise : null, 'allTokens' => $this->coin === CurrencyCode::ETHEREUM || $this->coin === CurrencyCode::ETHEREUM_TESTNET ? $allTokens : null];
        return $this->__execute('GET');
    }
    ...
    {
        $this->url = $this->APIEndpoint . '/wallet/' . $this->walletId . '/webhooks';
        $this->params = ['url' => $url, 'type' => $type, 'numConfirmations' => $numConfirmations];
        return $this->__execute();
    }
    ...
    public function simulateWalletWebhook(string $webhookId, string $transferId = null, string $pendingApprovalId = null)
    {
        ...
        $this->params = ['webhookId' => $webhookId, 'transferId' => $transferId, 'pendingApprovalId' => $pendingApprovalId];
        return $this->__execute();
    }
    ...
    {
        $this->url = $this->APIEndpoint . '/webhooks';
        $this->params = ['url' => $url, 'type' => $type, 'label' => $label, 'numConfirmations' => $numConfirmations];
        return $this->__execute();
    }
    ...
    public function simulateUserWebhook(string $webhookId, string $blockId = null)
    {
        ...
        $this->params = ['webhookId' => $webhookId, 'blockId' => $blockId];
        return $this->__execute();
    }
    ...
    {
        $this->url = $this->APIEndpoint . '/webhooks';
        $this->params = ['url' => $url, 'type' => (in_array($type, ['block', 'wallet_confirmation'])) ? $type : 'block', 'label' => $label, 'numConfirmations' => $numConfirmations];
        return $this->__execute();
    }
    ...
    {
        $this->url = $this->APIEndpoint . '/webhooks';
        $this->params = ['url' => $url, 'type' => (in_array($type, ['block', 'wallet_confirmation'])) ? $type : 'block'];
        return $this->__execute('DELETE');
    }
    ...
    public function estimateTransactionFees(int $numBlocks = null)
    {
        ...
        $this->params = ['numBlocks' => $numBlocks];
        return $this->__execute('GET');
    }
...
public function CoinFullName(string $coin = CurrencyCode::BITCOIN){

        $data=array('btc' => 'BITCOIN',
                    'bch' => 'BITCOINCASH',
                    'bsv' => 'BITCOINSV',
                    'btg' => 'BITCOINGOLD',
                    'dash' => 'DASH',
                    ...
                    'pay'  => 'TENXPAY', 
                    'brd'  => 'BREAD', 
                    'tbtc'  => 'BITCOIN_TESTNET', 
                    'tbch'  => 'BITCOIN_CASH_TESTNET', 
                    'tbsv'  => 'BITCOIN_SV_TESTNET', 
                    'tdash'  => 'DASH_TESTNET', 
                    'tltc'   => 'LITECOIN_TESTNET', 
                    'txrp'  => 'ZCASH_TESTNET', 
                    'tzec'  => 'RIPPLE_TESTNET', 
                    'trmg'   => 'ROYAL_MINT_GOLD_TESTNET', 
                    'terc' => 'ERC_TESTNET',
                    'txlm' => 'STELLAR_TESTNET');

        return strtolower($data[$coin]);
}
