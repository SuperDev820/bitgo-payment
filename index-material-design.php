...
<head>
  ...
  <meta http-equiv="x-ua-compatible" content="ie=edge">
   <title>Custom Payment!</title>
    ...
    <!-- Bootstrap core CSS -->
    <link href="assets/vendor/material/css/bootstrap.min.css" rel="stylesheet">
    <!-- Material Design Bootstrap -->
    <link href="assets/vendor/material/css/mdb.min.css" rel="stylesheet">
    <!-- Your custom styles (optional) -->
    <link href="assets/vendor/material/css/style.css" rel="stylesheet">
...
<body>
 ...
 <div class="container">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <h4 class="card-title  wallet-text-2"><a class="copyWallet" id="copyWallet" data-original-title="Copy Wallet" data-clipboard-target="#wallet" data-placement="bottom" data-toggle="tooltip"><spam id="wallet"><?php echo sanitize_str($payWallet)?></spam></a> </h4>

                                <p class="card-text mt-2"></p>

                                <div id="paymentStat">
                                    <span class="text btn btn-block btn-secondary btn-lg disabled"><i class="fa fa-spin fa-circle-o-notch"></i> <span id="staticTime"><?php echo gmdate('i:s', sanitize_str($product->invoice_time)); ?></span><span id="timer" data-seconds-left="<?php echo sanitize_str( $product->invoice_time); ?>"></span></span>
                                </div>
                                <br>

                                </p>
                                <p class="card-text" id="tips"><small class="text-muted">If you send any other <?php echo sanitize_str(strtoupper($coin)); ?> amount, payment system will ignore it!</small></p>
                            </div>
                        </div>
                    </div>
                </div>
      ...
      <script type="text/javascript" src="assets/vendor/material/js/bootstrap.min.js"></script>
      <!-- MDB core JavaScript -->
      <script type="text/javascript" src="assets/vendor/material/js/mdb.min.js"></script>
      <!--Do not remove-->
