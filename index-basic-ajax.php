                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <div id="paymentStat">
                                    <span class="text btn btn-block btn-secondary btn-lg disabled">
                                     <i class="fa-spin fas fa-circle-notch"></i> <span id="staticTime"><?php echo gmdate('i:s', sanitize_float($product->invoice_time)); ?></span><span id="timer" data-seconds-left="<?php echo sanitize_float($product->invoice_time); ?>"></span></span>
                                </div>
                                <br>
